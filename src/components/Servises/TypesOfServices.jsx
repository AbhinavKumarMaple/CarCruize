    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="DialogContent w-[856px] rounded-[10px] h-[403px]">
          <Dialog.Title className="DialogTitle  font-Montserrat font-bold text-[30px] shadow-lg bg-pila h-[112px] mt-[24px]">
            <div className="flex">
              <div>
                <img src={BackArrow} className="text-black" />
              </div>
          ...
          <div className="flex justify-center">
            <div className="grid-cols-2 grid font-lato gap-x-44 font-regular text-[20px] ">
          ...
          <Dialog.Close asChild className="">
            <div className=" flex justify-center">
              <button className="font-lato font-bold text-[30px] flex bg-bg text-TextWhite gap-[15px] h-[60px] items-center justify-center rounded-[10px] w-[320px]">
                <img src={DilogCart} />
                Add To Cart
              </button>
            </div>
