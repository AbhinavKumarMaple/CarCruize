      ...
      <div className="lg:flex  overflow-hidden h-96 max-w-96">
        ...
        <div className=" mx-auto my-auto  relative">
          <div className="border border-white text-white hover:text-black hover:bg-bg cursor-pointer mx-auto rounded-xl text-center w-[300px] h-[300px]">
            ...
            <h1 className="text- text-[24px] font-Montserrat font-bold py-2">
              {service}
            </h1>
          ...
          <div className="absolute w-full flex justify-center  -bottom-4">
            ...
            <button className="cursor-default text-black font-lato font-bold text-[20px] bg-pila  w-[175px]  rounded-[10px]  h-[50px]">
              book Now
            </button>
            </div>
          </div>
